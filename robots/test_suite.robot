...
${RAS_HOSTNAME}            Linux raspberrypi4 6.1.0-rpi7-rpi-v8 #1 SMP PREEMPT Debian 1:6.1.63-1+rpt1 (2023-11-24) aarch64 GNU/Linux
...
Check uname Raspberrypi4
  [tags]  Sanity    SSH    Raspberrypi
    ...
    ${uname_output}    Execute Command    uname -a
    Log    Hostname: ${uname_output}
    Should Be Equal     ${uname_output}     ${RAS_HOSTNAME}
